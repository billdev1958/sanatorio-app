...
type Register interface {
	RegisterSpecialty(ctx context.Context, sp entities.Specialty) (entities.Specialty, error)
	RegisterOffice(ctx context.Context, of entities.Office) (entities.Office, error)
	RegisterSchedule(ctx context.Context, sc entities.Schedule) (entities.Schedule, error)
